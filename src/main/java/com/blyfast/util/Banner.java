...
/**
 * Utility class for generating a stylish ASCII banner and system information for application
 * startup.
 */
public class Banner {
  ...
  public static String generate(String host, int port) {
    ...
    sb.append(ConsoleColors.CYAN_BOLD)
        .append(" :: Blyfast Framework ::")
        .append(ConsoleColors.RESET);
    ...
    sb.append(ConsoleColors.PURPLE)
        ...
        .append(ConsoleColors.WHITE)
        .append("http://")
        .append(host.equals("0.0.0.0") ? "localhost" : host)
        .append(":")
        .append(port)
        .append(ConsoleColors.RESET)
        .append(lineSeparator);
    ...
    sb.append(ConsoleColors.PURPLE)
        ...
        .append(" (")
        .append(props.getProperty("java.vendor"))
        .append(")")
        .append(ConsoleColors.RESET)
        .append(lineSeparator);
    ...
    sb.append(ConsoleColors.PURPLE)
        ...
        .append(" (")
        .append(props.getProperty("os.arch"))
        .append(")")
        .append(ConsoleColors.RESET)
        .append(lineSeparator);
    ...
    sb.append(ConsoleColors.PURPLE)
        .append(" 🧠 JVM: ")
        .append(ConsoleColors.WHITE)
        .append(runtimeMx.getVmName())
        .append(" (")
        .append(runtimeMx.getVmVendor())
        .append(", ")
        .append(runtimeMx.getVmVersion())
        .append(")")
        .append(ConsoleColors.RESET)
        .append(lineSeparator);
    ...
    sb.append(lineSeparator)
        .append(ConsoleColors.GREEN_BOLD)
