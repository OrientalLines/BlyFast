...
/**
 * Standalone example demonstrating JWT authentication and CORS functionality.
 * This example shows:
 * 1. How to configure and use JWT for authentication
 * 2. How to secure routes with JWT middleware
 * 3. How to configure and use CORS for cross-origin requests
 * 4. How to combine both plugins in a single application
 */
public class JwtCorsExampleApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("   curl -X POST http://localhost:" + port + "/auth/login -H \"Content-Type: application/json\" -d '{\"username\":\"john\",\"password\":\"password123\"}'");
        
        System.out.println("\n2. Login as admin:");
        System.out.println("   curl -X POST http://localhost:" + port + "/auth/login -H \"Content-Type: application/json\" -d '{\"username\":\"admin\",\"password\":\"admin123\"}'");
        
        System.out.println("\n3. Access protected profile (replace TOKEN with the token from login response):");
        System.out.println("   curl http://localhost:" + port + "/api/profile -H \"Authorization: Bearer TOKEN\"");
        
        System.out.println("\n4. Access admin dashboard (replace TOKEN with admin token):");
        System.out.println("   curl http://localhost:" + port + "/api/admin -H \"Authorization: Bearer TOKEN\"");
    }
