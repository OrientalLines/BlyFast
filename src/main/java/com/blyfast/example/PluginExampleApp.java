...
/**
 * Example application demonstrating the use of plugins in the BlyFast
 * framework.
 */
public class PluginExampleApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  GET  /api/user/profile - Protected user profile (requires authentication)");
        System.out.println("  GET  /api/admin/dashboard - Protected admin dashboard (requires admin role)");
