...
/**
 * Registry for registering and loading handlers. This provides a centralized way to manage and
 * discover handlers.
 */
public class HandlerRegistry {
  ...
  /**
   * Discovers and registers handlers using Java's ServiceLoader mechanism. This allows for
   * automatic discovery of handlers on the classpath.
   */
