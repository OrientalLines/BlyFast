...
/**
 * Manages routes and matches incoming requests to the appropriate handler. Optimized for
...
public class Router {
  ...
  /**
   * Finds a route that matches the given method and path. Optimized for performance with O(1)
   * lookups for static routes.
   *
   * @param method the HTTP method
  ...
  /**
   * Resolves the path parameters for a request based on the matching route. Validates path
   * parameters to prevent path traversal attacks.
   *
