...
public class CorsPlugin extends AbstractPlugin {
    ...
    public static class CorsConfig {
        ...
        private Set<String> allowMethods = new HashSet<>(Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        private Set<String> allowHeaders = new HashSet<>(Arrays.asList("Origin", "Content-Type", "Accept", "Authorization"));
