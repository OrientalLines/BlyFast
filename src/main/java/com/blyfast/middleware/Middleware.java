...
/**
 * Interface for middleware components. Middleware can process requests before they reach route
 * handlers and can be used for cross-cutting concerns like authentication, logging, CORS, etc.
 */
@FunctionalInterface
