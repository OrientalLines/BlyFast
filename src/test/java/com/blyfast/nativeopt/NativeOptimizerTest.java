 ...
 *
 * <p>Tests all native optimization methods including JSON parsing/escaping, HTTP header parsing,
 * form data parsing, and memory operations.
 */
...
public class NativeOptimizerTest {
  ...
  class StringToBytesTests {
    ...
    void testUnicodeStringToBytes() {
      ...
      // Test with basic unicode characters (avoid emoji which may have encoding
      // issues)
      String input = "Hello 世界";
      ByteBuffer result = NativeOptimizer.stringToDirectBytes(input);
  ...
  class HttpBodyAnalysisTests {
    ...
    void testDetectJsonContentType() {
      ...
      int bodyType =
          NativeOptimizer.nativeAnalyzeHttpBody(buffer, body.length(), "application/json");
    ...
    void testDetectFormDataContentType() {
      ...
      int bodyType =
          NativeOptimizer.nativeAnalyzeHttpBody(
              buffer, body.length(), "application/x-www-form-urlencoded");
    ...
    void testDetectMultipartContentType() {
      ...
      int bodyType =
          NativeOptimizer.nativeAnalyzeHttpBody(
              buffer, body.length(), "multipart/form-data; boundary=boundary");
