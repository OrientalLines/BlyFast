 ...
 *
 * <p>Tests route creation, matching, middleware management, and parameter handling.
 */
...
public class RouteTest {
  ...
  void testAddMultipleMiddleware() {
    ...
    route.use(middleware1).use(middleware2).use(middleware3);
  ...
  void testComplexRoute() {
    // Given: complex route
    Route route = new Route("GET", "/api/v1/users/:userId/posts/:postId", ctx -> ctx.json("post"));
